...
public class GlobalVariable
{
    ...
    //public static Time MoveTime;
    //public static bool[,] CargosState;//堆垛机对应货物状态集合
    //public static Queue<string> CargoNameQueue;//
    ...
    public static Queue<GameObject> TempQueue = new Queue<GameObject>();//出入库货物队列
